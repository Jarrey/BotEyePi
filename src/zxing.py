...
########################################################################
#
#  Modified by Jarrey (jar_bob@163.com) for Speedpro Inc.
...
if __name__ == "__main__":
  zx = BarCodeReader("../lib/zxing" + _zxing_ver)
  print zx.decode("../test/qrcode.png").data
  print zx.decode("../test/matrixcode.jpg").data